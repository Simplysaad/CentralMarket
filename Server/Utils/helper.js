...
// //helper functions
// const randomProductsFunc = (arr, n) => {
//     let randomProducts = new Array();
//     for (let i = 0; i < n; i++) {
//         let randomIndex = Math.floor(Math.random() * arr.length);

//         if (!randomProducts.includes(arr[randomIndex])) {
//             randomProducts.push(arr[randomIndex]);
//         }
//     }
...
// //   return data
// // })
// //const randomProducts = randomProductsFunc(allProducts, 12);
